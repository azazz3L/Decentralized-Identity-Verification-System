   ...
   <>{
    props.showIdentity && (
        ...
        <div>
            ...
            <input type="text" id="mnemonicInput" placeholder="Enter 12-word mnemonic" />
        </div>
        {showMnemonic && (<div id="identityInfo" >
            <div className="text-center"> 
                <h2>Mnemonic:</h2> 
                    <strong><span>{mnemonicValue}</span></strong>
                <h2>Private Key:</h2> 
                <strong><span>{privateKeyValue}</span></strong>
            </div>
        </div>)}
        
        {retrieve && (<div id="privateKeyInfo">
            <div className="text-center">
                <h2>Private Key:</h2>
                <strong><span>{privateKeyRetValue}</span></strong>
            </div>
        </div>)}
